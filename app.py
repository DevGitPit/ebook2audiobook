...
Tip: to add of silence (1.4 seconds) into your text just use "###" or "[pause]".
    ...
    headless_optional_group.add_argument(options[8], type=str, default=default_device, choices=list(devices.keys()), help=f'''(Optional) Pprocessor unit type for the conversion. 
